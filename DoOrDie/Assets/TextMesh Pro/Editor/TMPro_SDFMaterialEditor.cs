        ...
        switch (evt.type)
        {
            ...
            case EventType.DragPerform:
                ...
                if (evt.type == EventType.DragPerform)
                {
                    ...
                    {
                        if (go.GetComponent<TextMeshPro>() != null) go.GetComponent<TextMeshPro>().fontSharedMaterial = newMaterial;
                        if (go.GetComponent<TextMeshProUGUI>() != null) go.GetComponent<TextMeshProUGUI>().fontSharedMaterial = newMaterial;
                    }

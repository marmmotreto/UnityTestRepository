...
namespace TMPro
{
    ...
    public static class ShaderUtilities
    {
        ...
        public static bool IsMaskingEnabled(Material material)
        {
            ...
            if (material.shaderKeywords.Contains(ShaderUtilities.Keyword_MaskSoft) || material.shaderKeywords.Contains(ShaderUtilities.Keyword_MaskHard))
                return true;
        ...
        public static float GetPadding(Material material, bool enableExtraPadding, bool isBold)
        {
            ...
            if (material.HasProperty(ShaderUtilities.ID_UnderlaySoftness) && shaderKeywords.Contains(ShaderUtilities.Keyword_Underlay))
            {
                ...
                float offsetX = material.GetFloat(ShaderUtilities.ID_UnderlayOffsetX) * scaleRatio_C;
                float offsetY = material.GetFloat(ShaderUtilities.ID_UnderlayOffsetY) * scaleRatio_C;
                float dilate = material.GetFloat(ShaderUtilities.ID_UnderlayDilate) * scaleRatio_C;
                float softness = material.GetFloat(ShaderUtilities.ID_UnderlaySoftness) * scaleRatio_C;

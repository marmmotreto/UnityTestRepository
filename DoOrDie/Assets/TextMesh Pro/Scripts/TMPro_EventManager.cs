...
namespace TMPro
{
    ...
    public static class TMPro_EventManager
    {
        ...
        public delegate void DragAndDrop_Event_Handler(Material currentMaterial, Material newMaterial);
        ...
        public static void ON_DRAG_AND_DROP_MATERIAL_CHANGED(Material currentMaterial, Material newMaterial)
        {
            if (DRAG_AND_DROP_MATERIAL_EVENT != null)
                DRAG_AND_DROP_MATERIAL_EVENT(currentMaterial, newMaterial);
        }

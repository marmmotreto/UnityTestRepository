...
namespace TMPro
{
    ...
    public enum TextOverflowModes { Overflow = 0, Ellipsis = 1, Masking = 2, Truncate = 3, ScrollRect = 4 }; //, Pages = 5 };
    ...
    public partial class TextMeshPro : MonoBehaviour 
    {
        ...
        public Vector4 textRectangle
        {
            ...
            set { m_textRectangle = value; havePropertiesChanged = true; }
        }
